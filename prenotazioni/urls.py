...
from .views import AggiungiPrenotazioneView, AggiungiDisponibilitaView, AggiungiAssenzaView, VisualizzaPrenotazioniView, VisualizzaDisponibilitaView, EliminaDisponibilitaView
